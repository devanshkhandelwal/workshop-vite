    ...
    >
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../venus.jpg" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Venus Pham</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer science student at Purdue University, 1st year Hack The
              Future. I love this emoji 🤗🤗🤗
            </p>
          </div>
          <Link
            to="/"
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a
              href="https://www.linkedin.com/in/khue-pham-3b285b327/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/khuengocminhpham"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/whoskhue/"
              target="_blank"
              rel="noreferrer"
            >
