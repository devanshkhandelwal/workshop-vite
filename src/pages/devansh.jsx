    ...
    <div className={`h-screen w-screen bg-black ${showOutline ? 'outline' : ''}`}>
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../devansh.jpeg" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Devansh Khandelwal</h2>
            <h3 className="text-xl mt-2">Team Lead</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Hi! I'm a sophomore computer science student from New Delhi, India.
              I love solving problems through code and I'm really into football (⚽️)
            </p>
          </div>
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a href="https://www.linkedin.com/in/devansh-khandelwal-31b131213" target="_blank" rel="noreferrer">
              <FaLinkedin className="text-white text-4xl hover:animate-pop cursor-pointer" />
            </a>
            <a href="https://github.com/devanshkhandelwal" target="_blank" rel="noreferrer">
              <FaGithubSquare className="text-white text-4xl hover:animate-pop cursor-pointer" />
            </a>
            <a href="https://www.instagram.com/dev.ansh2501/" target="_blank" rel="noreferrer">
